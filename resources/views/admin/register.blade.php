    ...
    <x-guest-layout>
        <form method="POST" action="{{ route('register') }}"  style="direction: ltr">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-primary-button class="ms-4" style="    width: 18% !important;
                padding-right: 72px !important;background: rgb(31 41 55 / var(--tw-bg-opacity)) !important;border: none !important;">
                    {{ __('Register') }}
                </x-primary-button>
            </div>
        </form>
