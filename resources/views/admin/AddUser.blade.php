        ...
        <main style="font-style: normal" style="margin-right: 13rem;">
            <div class="container-fluid px-4" style="margin-top: 7rem">
                <div class="modal-body">
                    <form style="font-style: normal;margin: 0 7rem;" method="POST" action="{{ route('user.store') }}"> 
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                              <input type="password" name="password" class="form-control" id="exampleInputPassword1" style="border-top-left-radius: 0 !important;border-bottom-left-radius: 0 !important;border-radius: 4px;">
            ...
            <div class="container-fluid px-4">
                <div class="d-flex align-items-center justify-content-center small">
                    <div class="text-muted" style="display: flex;justify-content: center;"><img
                            src="{{ url('assets-ticket/img/Frame.svg') }}" alt="" style="max-width: 30%;"></div>
                </div>
            </div>
        </footer>
    </div>
