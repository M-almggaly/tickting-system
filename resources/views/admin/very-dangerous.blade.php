...
<head>
    ...
    <title>Admin-very-dangerous-Ticket</title>
     {{-- شعار الصفحه --}}
...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
        <main style="font-style: normal;margin-right: 15rem;margin-left: 1rem;">
            <h1 class="mt-4"  style="font-family: 'Alexandria', sans-serif;font-size: 40px">المستعجلة</h1>
            <ol class="breadcrumb mb-4" style="font-family: 'Alexandria', sans-serif;font-size: 13px">
                <li class="breadcrumb-item active" style="color: #dc3546b9"> المستعجلة /</li>
