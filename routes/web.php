...
Route::post('/show-ticket', [TicketController:: class, 'showTicket'])->middleware(['auth', 'verified'])->name('show.ticket');
Route::put('/admin/{id}', [TicketController::class, 'update'])->middleware(['auth', 'verified'])->name('show-ticket.update');
